...
#define dnnTensorTypeMaskBias			0x4
#define dnnTensorTypeMaskFilter			0x5
#define dnnTensorTypeMaskFullConnection		0x6

#define dnnPoolingMaskAvg			0x0
#define dnnPoolingMaskMax			0x4

#define	dnnActivationMaskReLU			0x4
#define	dnnActivationMaskTanh			0x5
#define	dnnActivationMaskSigmod			0x6

#define dnnReductionMaskAdd			0x0
#define dnnReductionMaskMax			0x1
#define dnnReductionMaskMin			0x2
...
__APIENTRY__	size_t			__APICALL__ dnnExportTensorPitch( uint64 );
...
__APIENTRY__	dnnStatus_t		__APICALL__ dnnCreateReductionOp( dnnReductionOp*, int, unsigned int, uint64 );
