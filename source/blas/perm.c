...
void idc_perm3d_create_kernel( cuda_kernel_t* p, const cuda_context_t* p_ctx, int prc, int idx, int nx, int ny, int nz, int lda, int ldb )
{
	static const char* knames[2][3]=
	{
		{ "dk_perm_xzy_b64", "dk_perm_xyz_b64", "dk_perm_yxz_b64" },
		{ "dk_perm_xzy_b32", "dk_perm_xyz_b32", "dk_perm_yxz_b32" }
	};
...
void idc_perm2d_create_kernel( cuda_kernel_t* p, const cuda_context_t* p_ctx, int prc, int nx, int ny, int lda, int ldb )
{
	cuda_context_create_kernel( p, p_ctx, prc?"dk_perm2d_b32":"dk_perm2d_b64" );
...
void idc_permute( cuda_kernel_t* p, CUdeviceptr d_b, CUdeviceptr d_a, CUstream s )
{
