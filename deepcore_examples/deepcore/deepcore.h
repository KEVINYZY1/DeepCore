...
DEEPCOREAPIENTRY dc_status_t DEEPCOREAPICALL dc_create_convOp( dc_convOp*, uint32_t, int, uint64_t, uint64_t, uint64_t, uint32_t );
...
DEEPCOREAPIENTRY dc_status_t DEEPCOREAPICALL dc_fftconv_grad( dc_fftconvOp, void*, void*, const void*, const void*, CUstream );
...
DEEPCOREAPIENTRY dc_status_t DEEPCOREAPICALL dc_cellconv_grad( dc_cellconvOp, void*, void*, const void*, const void*, CUstream );
DEEPCOREAPIENTRY dc_status_t DEEPCOREAPICALL dc_gemm( dc_gemmOp, void*, const void*, const void*, const void*, float, CUstream );
DEEPCOREAPIENTRY dc_status_t DEEPCOREAPICALL dc_gemm_grad( dc_gemmOp, void*, const void*, const void*, CUstream );
