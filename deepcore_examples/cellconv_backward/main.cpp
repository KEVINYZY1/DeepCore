...
int main()
{
	...
	tensor_shape_t shapes[]={{48,3,32,64,8},{24,3,32,64,1},{10,3,32,32,1},{14,3,32,32,32},{4,3,32,96,1}};
	...
	for( int e=0; e<sizeof(shapes)/sizeof(shapes[0]); e++ )
	{
		...
		dc_cellconvOp Op;
		size_t auxnb;
		if(dc_create_cellconvOp( &Op, &auxnb, dcMaskPrecisionFloat|dcMaskDirectionBackward, pshape, kshape, qshape, (pad<<8)|pad )!=dc_success){
