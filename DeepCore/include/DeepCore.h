...
#define dcMaskConvAddBias               0x00000008
#define dcMaskConvMulDiff               0x00000008
...
DEEPCOREAPIENTRY dc_status_t DEEPCOREAPICALL dc_conv( dc_convOp, void*, const void*, const void*, const void*, const float*, CUstream );
