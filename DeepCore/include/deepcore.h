...
DEEPCOREAPIENTRY dc_status_t DEEPCOREAPICALL dc_tensor_input( void*, uint64_t, const void*, size_t, size_t, size_t, CUstream );
DEEPCOREAPIENTRY dc_status_t DEEPCOREAPICALL dc_tensor_output( void*, size_t, const void*, uint64_t, size_t, size_t, CUstream );

DEEPCOREAPIENTRY dc_status_t DEEPCOREAPICALL dc_create_convOp( dc_convOp*, uint32_t, uint64_t, uint64_t, uint64_t, uint32_t, uint32_t );
...
DEEPCOREAPIENTRY dc_status_t DEEPCOREAPICALL dc_create_poolingOp( dc_poolingOp*, uint32_t, uint64_t, uint64_t, uint32_t, uint32_t );
...
DEEPCOREAPIENTRY dc_status_t DEEPCOREAPICALL dc_reduce( dc_reduceOp, void*, const void*, float, CUstream );
